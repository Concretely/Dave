...
//  String _authURL = HuMedStatics.CMS_BB_AUTH_URL + "&state="  + new Uuid().v4().toString();
  String _authURL = "https://mitatac.github.io/smart-on-fhir-tutorial/example-smart-app/launch-patient.html?iss=https://fhir-myrecord.sandboxcerner.com/dstu2/0b8a0111-e8e6-4c26-a91c-5069cbc6b1ca"+ "&state="  + new Uuid().v4().toString();
        ...
        home: new Scaffold(
            ...
            body: new Center(
                child: new Column(
                  ...
                  new Text("Launching Cerner Authorization:")
                ]))));
      ...
      if (mounted) {
        setState(() {
          ...
          if (uri.host == "localhost") {
            ...
            print("Here is the access Token $token");

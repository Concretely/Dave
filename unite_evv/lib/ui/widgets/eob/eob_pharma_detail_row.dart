...
Widget buildSummaryRow(int row, BenefitEntry benefitEntry) {
  BenefitEntryItem entryItem = benefitEntry.benefitEntryItems[
      0]; //For pharmacy: it's assumed that there is always only one item
  ...
  switch (row) {
    case 0:
      ...
      String ndcCodeDisplay = entryItem.serviceCodeDisplay == null
          ? "Unknown"
          : benefitEntry.benefitEntryItems[row].serviceCodeDisplay;
      title = "NDC:$ndcCode";
    ...
    case 3:
      ...
      if (benefitEntry.facility != null) {
        name = benefitEntry
            .facility.facilityName; //TODO: Get Pharmacy Name from look up
      }
      if (name == null) {
        name = "";
      }
...
Widget buildProviderRow(int row, BenefitEntry benefitEntry) {
  ...
  String name = benefitEntry.providers[row].providerName == null
      ? ''
      : benefitEntry.providers[row].providerName;
